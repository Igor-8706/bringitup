  ...
  _createClass(Difference, [{
    ...
    value: function bindTriggers(container, items, counter) {
      ...
      container.querySelector('.plus').addEventListener('click', function () {
        if (_this.oldCounter !== items.length - 2) {
    ...
    value: function checkMailInputs() {
      ...
      mailInputs.forEach(function (input) {
        input.addEventListener('input', function () {
          try {
            if (input.value.match(/[^a-z 0-9 @ \.\-]/ig).length != input.value.length) {
              input.value = '';
            }
          } catch (_unused) {}
      ...
      try {
        ...
        this.btns.forEach(function (btn) {
          btn.addEventListener('click', function () {
            ...
            _this2.slides[_this2.slideIndex - 1].classList.add('fadeIn', 'animate__slow');
          });
...
var Slider = function Slider() {
  ...
  } catch (e) {} // console.log(this.container);
